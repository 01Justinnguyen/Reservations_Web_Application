...
import { useGetInfoEmployee, useUpdateAccountMutation } from '@/queries/useAccount'
import { toast } from '@/components/ui/use-toast'
import { useUploadMediaMutation } from '@/queries/useMedia'
import { handleErrorApi } from '@/lib/utils'

export default function EditEmployee({ id, setId, onSubmitSuccess }: { id?: number | undefined; setId: (value: number | undefined) => void; onSubmitSuccess?: () => void }) {
  const [file, setFile] = useState<File | null>(null)
  const avatarInputRef = useRef<HTMLInputElement | null>(null)
  const updateAccountMutation = useUpdateAccountMutation()
  const uploadImageMutaion = useUploadMediaMutation()
  const { data } = useGetInfoEmployee({
